...
<body>
    ...
    <div class="row">
        <div class="col-4">Update Event</div>
        <div class="col-8">
            ...
            <form method="POST" action="{{route('updateevent')}}">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group mb-2">
                    ...
                    <input type="text" name="Eventname" value="{{$eventdetails->name}}"class="form-control" id="inlineFormInputGroup" placeholder="Playing Cricket">
                  </div>
                </div>
                <div class="form-group">
